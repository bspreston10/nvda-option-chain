...
# Reading the ZIP file from the repository
with zipfile.ZipFile('final_nvda_2023.csv.zip', 'r') as z:
    # List files inside the ZIP to confirm the correct filename
    file_list = z.namelist()
    st.write("Files inside ZIP:", file_list)  # This helps verify the file structure

    # Open the first CSV file found in the ZIP
